...
In part 2, I integrated several tools: Redux Toolkit, Redux Persist, and React Redux, to manage and persist backend data, enabling seamless user sign-in retention. Leveraging Firebase for OAuth login, I extracted and presented user information in a dropdown menu. Next, I'll develop a dashboard allowing users to modify their email, username, and password.
...
- [Redux Toolkit](https://github.com/reduxjs/redux-toolkit) - An open-source library that simplifies Redux development by providing utilities for writing Redux logic, including reducers, action creators, and middleware, in a more concise and efficient manner.
- [React Redux](https://github.com/reduxjs/react-redux) - A a library that integrates Redux state management with React applications, providing bindings to connect Redux to React components efficiently.
- [Redux Persist](https://github.com/rt2zz/redux-persist) - An open-source library that enables seamless persisting and rehydrating of Redux store state in web and mobile applications across sessions.
- [jsonwebtoken](https://github.com/auth0/node-jsonwebtoken) - An open-source library for generating, signing, verifying, and decoding JSON Web Tokens (JWT) in Node.js and browser-based applications, commonly used for secure authentication and authorization.
